...
1. How to develop a java application (Rest API based) using Spring Boot framework and DSE enterprise java driver together for data interaction with a DSE cluster.
