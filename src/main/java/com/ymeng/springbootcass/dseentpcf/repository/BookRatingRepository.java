package com.ymeng.springbootcass.dseentpcf.repository;
...
public class BookRatingRepository {
    ...
    public BookRating findRating(UUID book_id, String author_code, int rating_year) {
        return mapper.get(book_id, author_code, rating_year);
    }
